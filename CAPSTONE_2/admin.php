...
<h2><a href="AddPlayer.php" class="grid-item"><button class="button"><span>Add Player</span></h2>
<h2><a href="Deletepage.php" class="grid-item"><button class="button"><span>Delete Player</span></h2>
